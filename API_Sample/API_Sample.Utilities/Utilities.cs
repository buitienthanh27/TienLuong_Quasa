...
namespace API_Sample.Utilities
{
    public static partial class Utilities
    {
        ...
        #region Payroll Rounding Rules - Quy tắc làm tròn lương

        /// <summary>
        /// Cắt lấy 2 số thập phân (không làm tròn)
        /// Ví dụ: 123.456789 => 123.45
        /// </summary>
        ...
        /// <summary>
        /// Cắt phần thập phân của mủ tươi (không có số lẻ)
        /// Ví dụ: 9.3 kg => 9 kg
        /// </summary>
        public static decimal TruncateRawLatex(decimal value)
        {
            return Math.Truncate(value);
        }

        /// <summary>
        /// Làm tròn xuống tới đơn vị nghìn (hàng trăm, chục, đơn vị = 000)
        /// Ví dụ: 10,768,456 => 10,768,000
        /// </summary>
        public static decimal RoundDownToThousand(decimal value)
        {
            return Math.Floor(value / 1000) * 1000;
        }

        /// <summary>
        /// Format số với dấu chấm thập phân và 2 chữ số sau dấu phẩy
        /// </summary>
        public static string FormatDecimal2(decimal value)
        {
            return Truncate2Decimals(value).ToString("0.00", CultureInfo.InvariantCulture);
        }

        /// <summary>
        /// Format tiền lương với phân cách hàng nghìn
        /// </summary>
        public static string FormatSalary(decimal value)
        {
            return RoundDownToThousand(value).ToString("N0", CultureInfo.InvariantCulture);
        }
